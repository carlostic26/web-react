...
export function NavBarResp() {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 w-full items-center justify-between bg-personalizado-secundary/80 backdrop-blur-sm bg-muted/80 px-4 md:px-6  mr-16">
